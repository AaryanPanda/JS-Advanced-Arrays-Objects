...
const output1 = strings.filter(function(item){
...
const output2 = numbers.map(function(item) {
  return item**2
})
console.log(output2)
...
const output3 = alphabets.reduce(function(result,item){
  return result+item
})
console.log(output3)
...
const output4 = number.find(function(item){
  return item%2==0
})
console.log(output4)
...
const output5 = ranks.findIndex(function(item){
  return item=="7" 
})
console.log(output5)
...
const output6 = num.forEach(function(item,index){
...
const output7 = marks.some(function(item){
  return item<45
})
console.log(output7)
...
const output8 = positive.every(function(item){
  return item>0
})
console.log(output8)
